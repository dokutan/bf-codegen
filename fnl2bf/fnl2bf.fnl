...
1. compiling the `inc2_3_factors` module, e.g. by running `make`
2. placing the file `inc2-3.csv` (generated by `../constants/inc2-3.jl`) in the same directory as the `inc2_3_factors` module
